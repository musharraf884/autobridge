...
# autobridge - Cypress Test Automation

This repository contains the test automation framework for the autobridge Web app project, built using Cypress in JavaScript. The framework is designed to automate end-to-end testing scenarios, ensuring the reliability and stability of the application.
...
module.exports = {
    e2e: {
        baseUrl: 'https://www-dev2.autobridge.com"', 
        viewportWidth: 1280,
        viewportHeight: 720,
    },
};
